...
public class PortfolioManagerFactory {
  ...
  //       ./gradlew test --tests PortfolioManagerFactory
   ...
   public static PortfolioManager getPortfolioManager(String provider, RestTemplate restTemplate) {
    StockQuotesService newService = StockQuoteServiceFactory.INSTANCE.getService(provider, restTemplate);

    //Using the "newService" above, create the instance of PortfolioManager.
    PortfolioManager portfolioManager = new PortfolioManagerImpl(newService);
